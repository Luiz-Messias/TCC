<template>
  <div class="p-6">
    <!-- Header -->
    <div class="mb-6">
      <h1 class="text-2xl font-bold text-gray-900 mb-2">Gerenciamento de Categorias</h1>
      <div class="mt-2 text-sm text-gray-500 flex items-center">
        ...
        <span
          ...
          <kbd class="px-2 py-1 bg-gray-100 border border-gray-300 rounded text-xs font-mono"
            >Tab</kbd
          >
          para criar nova categoria rapidamente</span
        >
      </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow">
      ...
      <!-- Tabela -->
      <div v-else-if="categorias.length > 0" class="overflow-x-auto">
      ...
      <!-- Paginação -->
      <div
        v-if="categorias.length > 0 && totalPaginas > 1"
        class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6"
      >
        <div class="flex-1 flex justify-between sm:hidden">
          <button
            @click="paginaAtual > 1 && (paginaAtual--, listarCategorias())"
          ...
          <button
            @click="paginaAtual < totalPaginas && (paginaAtual++, listarCategorias())"
          ...
          <div>
            <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
              ...
              <button
                ...
                :key="pagina"
                @click="pagina !== '...' && ((paginaAtual = pagina), listarCategorias())"
                :class="[
    ...
    >
      <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
        ...
        <div class="flex gap-3 justify-end">
          <button
            @click="categoriaParaExcluir = null"
